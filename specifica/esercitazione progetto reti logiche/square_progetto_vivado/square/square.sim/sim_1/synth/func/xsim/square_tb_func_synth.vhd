...
-- Date        : Tue Nov 26 13:28:43 2019
-- Host        : fede-hp running 64-bit Ubuntu 19.04
-- Command     : write_vhdl -mode funcsim -nolib -force -file
--               /home/fede/square/square.sim/sim_1/synth/func/xsim/square_tb_func_synth.vhd
-- Design      : square
...
entity datapath is
  port (
    ...
    \i_data[7]\ : in STD_LOGIC_VECTOR ( 7 downto 0 )
  );
end datapath;
...
architecture STRUCTURE of datapath is
  ...
  signal \o_reg3_reg__0\ : STD_LOGIC_VECTOR ( 7 downto 0 );
...
DATAPATH0: entity work.datapath
     port map (
      ...
      \i_data[7]\(7 downto 0) => i_data_IBUF(7 downto 0),
      o_data_OBUF(7 downto 0) => o_data_OBUF(7 downto 0),
      \out\(2 downto 0) => cur_state(2 downto 0)
    );
